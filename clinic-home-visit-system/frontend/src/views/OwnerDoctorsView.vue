  ...
  <div class="min-h-screen bg-gray-50 flex">
    ...
    <aside class="w-64 bg-emerald-900 text-white flex flex-col min-h-screen fixed left-0 top-0">
      ...
      <nav class="flex-1 px-3 py-4 space-y-1">
        ...
        <router-link to="/owner/revenue" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors"
          :class="$route.path === '/owner/revenue' ? 'bg-emerald-600 text-white' : 'text-emerald-200 hover:bg-emerald-800 hover:text-white'">
